  ...
  <!-- if logo is image enable this -->
    ...
    <div class="sidebar-menu-inner">
      ...
      <ul class="nav nav-pills nav-stacked custom-nav">
        ...
        <li class="menu-list">
          <a href="#"><i class="fa-album-collection-circle-user"></i></i>
            <span>Collective <i class="lnr lnr-chevron-right"></i></span></a>
          <ul class="sub-menu-list">
        ...
        <li class="menu-list">
          <a href="#"><i class="fa-album-collection-circle-user"></i></i>
            <span>macro <i class="lnr lnr-chevron-right"></i></span></a>
          <ul class="sub-menu-list">
            <li><a href="laravelmacro">laravelmacro</a> </li>
            >
          </ul>
        </li>
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a href="#" class="grid">
                      <div class="user_img"><img src="{{url('assets/images/avatar1.jpg')}}" alt=""></div>
